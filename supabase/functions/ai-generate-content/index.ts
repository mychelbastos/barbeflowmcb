...
{"title": "...", "description": "..."}`;
      ...
      const imagePrompts: Record<AllowedTable, string> = {
        ...
        subscription_plans: `Premium VIP membership card concept for "${item.name}"${item.description ? ` (${item.description})` : ''}. Exclusive feel with gold and dark tones, modern clean design, professional marketing aesthetic. IMPORTANT: Do NOT include any text, words, letters, watermarks, logos or typography in the image.`,
      };
